      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card variant="elevated">
          <CardContent>
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              {error &&
                ...
                !error.toLowerCase().includes('password') && (
                  <div className="flex items-center gap-2 rounded-[var(--radius)] border border-[color:var(--color-danger)] bg-[color:var(--color-danger-light)]/10 p-3">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 24 24"
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="flex-shrink-0 text-[color:var(--color-danger)]"
                    >
            ...
            <div className="mt-6">
              <div className="mb-4 text-center text-xs text-[color:var(--color-muted-foreground)]">
                By creating an account, you agree to our{' '}
                <Link
                  href="#"
                  className="text-[color:var(--color-accent)] hover:text-[color:var(--color-accent-hover)]"
                >
                  Terms of Service
                </Link>{' '}
                and{' '}
