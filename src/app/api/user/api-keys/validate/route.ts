            ...
            return NextResponse.json(
              {
                ...
                userMessage:
                  "The API key doesn't have permission to access this model. Please check your account permissions.",
                valid: false,
              },
              { status: 403 },
            );
            ...
            return NextResponse.json(
              {
                ...
                userMessage:
                  'The API key has exceeded rate limits. The key appears to be valid but is currently rate limited.',
                valid: true,
            ...
            return NextResponse.json(
              {
                ...
                userMessage:
                  "OpenAI's servers are currently experiencing issues. Please try again later.",
                valid: null,
              },
              { status: 500 },
            );
        ...
        return NextResponse.json(
          {
            error: 'Network error',
            userMessage:
              "Unable to connect to OpenAI's servers. Please check your internet connection.",
            valid: null,
          },
          { status: 500 },
        );
