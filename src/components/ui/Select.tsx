    ...
    return (
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <div className="absolute right-3 xl:right-4 2xl:right-5 3xl:right-6 4xl:right-8 top-1/2 transform -translate-y-1/2 pointer-events-none text-[color:var(--color-muted-foreground)]">
            <svg className="w-4 h-4 xl:w-5 xl:h-5 2xl:w-6 2xl:h-6 3xl:w-7 3xl:h-7 4xl:w-8 4xl:h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="m6 9 6 6 6-6"/>
            </svg>
          </div>
        </div>
